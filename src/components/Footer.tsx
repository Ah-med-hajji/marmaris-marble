    ...
    <footer className="bg-charcoal text-white/70" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-serif text-white font-semibold mb-4">{t("links")}</h3>
            <ul className="space-y-2">
              <li><a href="#hero" className="text-sm hover:text-gold transition-colors">{nav("home")}</a></li>
              <li><a href="#about" className="text-sm hover:text-gold transition-colors">{nav("about")}</a></li>
              <li><a href="#products" className="text-sm hover:text-gold transition-colors">{nav("products")}</a></li>
              <li><a href="#contact" className="text-sm hover:text-gold transition-colors">{nav("contact")}</a></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div>
            <h3 className="font-serif text-white font-semibold mb-4">{t("contactInfo")}</h3>
